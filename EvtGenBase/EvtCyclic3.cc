 ...
 * Package: EvtGenBase
 *    File: $Id: EvtCyclic3.cc 702 2010-09-13 11:07:21Z stroili $
...
const char* EvtCyclic3::append(const char* str, EvtCyclic3::Index i)
{
...
const char* EvtCyclic3::append(const char* str, EvtCyclic3::Pair i)
{
