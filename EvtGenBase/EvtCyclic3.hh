 ...
 * Package: EvtGenBase
 *    File: $Id: EvtCyclic3.hh 702 2010-09-13 11:07:21Z stroili $
...
namespace EvtCyclic3 {
  ...
  const char* append(const char* str, EvtCyclic3::Index i);
  const char* append(const char* str, EvtCyclic3::Pair i);
