...
//      $Id: EvtMultiChannelParser.cc 755 2010-09-24 13:11:49Z stroili $
// 
// Environment:
...
void EvtMultiChannelParser::parse(const std::vector<std::string>& v)
{
  ...
  printf("%u amplitude terms\n",(unsigned int)_amp.size());
  printf("%u conj amplitude terms\n",(unsigned int)_ampConj.size());
}
