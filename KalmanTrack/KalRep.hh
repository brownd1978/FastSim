...
// fast constructor taking DetIntersections from outside.  TAKES OWNERSHIP of the seed
 KalRep(TrkSimpTraj*,TrkHotList* hots,const std::vector<DetIntersection>& dlist,
 	TrkRecoTrk*,const KalContext& context,PdtPid::PidType hypo);
// same, supplying also piecetraj as initial ref traj.  The KalRep TAKES OWNERSHIP of the seed and reftraj
KalRep(TrkSimpTraj*, TrkDifPieceTraj*,TrkHotList* hots,const std::vector<DetIntersection>& dlist,
	TrkRecoTrk*,const KalContext& context,PdtPid::PidType hypo);
