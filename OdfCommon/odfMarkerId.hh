#ifndef ODF_MARKER_ID_HH
#define ODF_MARKER_ID_HH

//
// Enumeration of the types of odfMarker that are available
// (see Odf/utility/odfMarker.hh). 
//
// $Id: odfMarkerId.hh 159 2010-01-15 08:50:21Z stroili $
// $Name: V00-07-01 $
//
