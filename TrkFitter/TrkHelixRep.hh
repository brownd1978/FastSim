...
//      $Id: TrkHelixRep.hh 104 2010-01-15 12:13:14Z stroili $
//
// Description:
...
public:
  ...
  TrkHelixRep(const TrkExchangePar& , TrkRecoTrk* , PdtPid::PidType, bool createHotList=true);
  TrkHelixRep(const TrkExchangePar& , TrkRecoTrk* , PdtPid::PidType , const TrkHotList&);
  TrkHelixRep(const TrkExchangePar& , TrkRecoTrk* , PdtPid::PidType , TrkHotList&, bool stealHots);
  TrkHelixRep(const TrkExchangePar& , TrkRecoTrk* ,
