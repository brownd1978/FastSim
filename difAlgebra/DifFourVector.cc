...
CLHEP::HepSymMatrix DifFourVector::errorMatrix(const CLHEP::HepSymMatrix& e)const {
  CLHEP::HepSymMatrix temp(4);
...
CLHEP::HepMatrix DifFourVector::jacobian()const{
  int npar=E.nPar();
  CLHEP::HepMatrix temp(4,npar);
